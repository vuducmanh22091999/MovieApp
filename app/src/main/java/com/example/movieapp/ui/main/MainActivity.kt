            ...
            when (it.itemId) {
                ...
                R.id.favouritesFragment -> {
                    if (currentFragment === favoriteFragment)
                        ...
                        fragmentManager.beginTransaction().hide(currentFragment).show(favoriteFragment).commit()
                ...
                R.id.accountFragment -> {
                    if (currentFragment === accountFragment)
                        ...
                        fragmentManager.beginTransaction().hide(currentFragment).show(accountFragment).commit()
